...
import com.pc.global.PcAppException;

public class AbIocEventListener implements OnClickListener, OnLongClickListener, OnItemClickListener,
	...
	private static Object invokeClickMethod(Object handler, String methodName, Object... params) {
		...
		try {
			...
			if (method != null)
				...
				throw new PcAppException("no such method:" + methodName);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private static boolean invokeItemLongClickMethod(Object handler, String methodName, Object... params) {
		...
		try {
			if (handler == null) {
				throw new PcAppException("invokeItemLongClickMethod: handler is null :");
			}
