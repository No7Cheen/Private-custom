...
public class SimpleGestureDetectorFrame extends FrameLayout {
	 ...
	 * @param defStyle
	 */
	public SimpleGestureDetectorFrame(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param attrs
	 */
	public SimpleGestureDetectorFrame(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	 ...
	 * @param context
	 */
	public SimpleGestureDetectorFrame(Context context) {
		super(context);
	}
