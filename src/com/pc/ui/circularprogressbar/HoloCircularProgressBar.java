 ...
 * 
 */
package com.pc.ui.circularprogressbar;
...
public class HoloCircularProgressBar extends View {
	...
	/**
	 * The Constant TAG. private static final String TAG =
	 ...
	 */
	private final String INSTNACE_STATE_SAVEDSTATE = "saved_state";

	/**
	 * used to save the progress on configuration changes
	 */
	private final String INSTNACE_STATE_PROGRESS = "progress";

	/**
	 * used to save the marker progress on configuration changes
	 */
	private final String INSTNACE_STATE_MARKER_PROGRESS = "marker_progress";

	/**
	 * used to save the background color of the progress
	 */
	private final String INSTNACE_STATE_PROGRESS_BACKGROUND_COLOR = "progress_background_color";

	/**
	 * used to save the color of the progress
	 */
	private final String INSTNACE_STATE_PROGRESS_COLOR = "progress_color";
	 ...
	 * given bounds {@link #computeInsets(int, int)}
	 */
	...
	/**
	 * The Thumb pos x. Care. the position is not the position of the rotated
	 * thumb. The position is only calculated in {@link #onMeasure(int, int)}
	 */
	private float mThumbPosX;

	/**
	 * The Thumb pos y. Care. the position is not the position of the rotated
	 * thumb. The position is only calculated in {@link #onMeasure(int, int)}
	 */
	...
	private void updateMarkerColor() {
		if (-1 == mMarkerColor) {
			mMarkerColor = mProgressBackgroundColor;
		}

		mMarkerColorPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
		mMarkerColorPaint.setAntiAlias(true);
		mMarkerColorPaint.setColor(mMarkerColor);// mProgressBackgroundColor
