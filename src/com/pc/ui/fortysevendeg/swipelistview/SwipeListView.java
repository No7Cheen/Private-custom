/*
 * Copyright (C) 2013 47 Degrees, LLC http://47deg.com hello@47deg.com Licensed
...
public class SwipeListView extends ListView {
	...
	/**
	 * Notifies onLongClicFrontView
	 * @param position
	 */
	protected void onLongClicFrontView(int position) {
		if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
			swipeListViewListener.onLongClicFrontView(position);
		}
	}
