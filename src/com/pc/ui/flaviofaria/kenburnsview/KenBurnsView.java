...
import com.pc.ui.flaviofaria.kenburnsview.libs.KenBurnsViewRandomTransitionGenerator;
import com.pc.ui.flaviofaria.kenburnsview.libs.KenBurnsViewTransition;
import com.pc.ui.flaviofaria.kenburnsview.libs.KenBurnsViewTransitionGenerator;
 ...
 * @author Flavio Faria
 * @see KenBurnsViewTransition
 * @see KenBurnsViewTransitionGenerator
 */
public class KenBurnsView extends ImageView {
	...
	/** The {@link KenBurnsViewTransitionGenerator} implementation used to perform the transitions between
	 *  rects. The default {@link KenBurnsViewTransitionGenerator} is {@link KenBurnsViewRandomTransitionGenerator}. */
	private KenBurnsViewTransitionGenerator mTransGen = new KenBurnsViewRandomTransitionGenerator();
	...
	private KenBurnsViewTransition mCurrentTrans;
	 ...
	 */
	private void fireTransitionStart(KenBurnsViewTransition transition) {
	 ...
	 */
	private void fireTransitionEnd(KenBurnsViewTransition transition) {
		if (mTransitionListener != null && transition != null) {
	...
	/**
	 * Sets the {@link KenBurnsViewTransitionGenerator} to be used in animations.
	 * @param transgen the {@link KenBurnsViewTransitionGenerator} to be used in animations.
	 */
	public void setTransitionGenerator(KenBurnsViewTransitionGenerator transgen) {
		mTransGen = transgen;
		startNewTransition();
	}
	...
	public interface TransitionListener {
		 ...
		 * @param transition the transition that just started.
		 */
		public void onTransitionStart(KenBurnsViewTransition transition);

		/**
		 * Notifies the end of a transition.
		 * @param transition the transition that just ended.
		 */
		public void onTransitionEnd(KenBurnsViewTransition transition);
	}
}
