...
import com.pc.ui.plus.calendar.PcMonthItemView.OnDayClickListener;
 ...
 */
public class PcMonthListView extends ListView implements OnScrollListener, OnDayClickListener {
	...
	public PcMonthListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public PcMonthListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	private void init(Context context) {
		setAdapter(new PcMonthListAdapter(context, YEARFROM, YEARTO, this));
	...
	private OnGlobalLayoutListener mGlobalLayoutListener = new OnGlobalLayoutListener() {
		...
		public void onGlobalLayout() {
			...
			params.height = getChildAt(0) != null ? getChildAt(0).getHeight() : 0;
