...
public class PcMonthListAdapter extends BaseAdapter {
	...
	public PcMonthListAdapter(Context context, int yearFrom, int yearTo, OnDayClickListener l) {
		if (yearFrom > yearTo) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		PcMonthItemView item = Holder.get(convertView, R.id.item);
		...
		txt.setText(mContext.getResources().getString(R.string.arg1_year_arg2_month, year, (month + 1)));
