...
public interface DbDBDao<T> {
	 ...
	 * @param ids 数据ID主键
	 */
	public abstract long delete(int... ids);
	 ...
	 * @return 修改成功的数据行号和
	 */
	public abstract long update(List<T> entityList, String whereClause, String[] whereArgs);
	 ...
	 * @param selectionArgs where语句变量的参数
	 * @return
	 */
	 ...
	 * @return
	 */
	public abstract boolean exists(String[] columns, String selection, String[] selectionArgs);
