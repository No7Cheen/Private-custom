...
public final class ChineseCalendar extends GregorianCalendar {
	...
	public String getChineseDateString() {
		return new StringBuffer().append(getChinese(CHINESE_YEAR)).append("年").append(getChinese(CHINESE_MONTH))
				.append("月").append(getChinese(CHINESE_DATE)).toString();
	}
	 ...
	 * @return
	 */
	public String getSingleLunarDay() {
		getChinese(CHINESE_YEAR);
		String singleLunar = getChinese(CHINESE_DATE);
		if ("初一".equals(singleLunar)) {
			return getChinese(CHINESE_MONTH);
		}
	...
	public String toString() {
		...
		buf.append(getSimpleGregorianDateString()) // 公历
				...
				.append(getChineseDateString()) // 农历

				.append(" ")

				.append(getChinese(CHINESE_ANIMAL)) // 属性年
				...
				.append(getChinese(CHINESE_SECTIONAL_TERM))// 节气
	...
	public String cyclical() {
		return new StringBuffer(getChinese(CHINESE_YEAR)).append("年").toString();
	}
}
