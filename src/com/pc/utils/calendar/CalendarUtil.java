...
public class CalendarUtil {
	...
	public CalendarUtil(Calendar cal) {
		int yearCyl = Calendar.getInstance().YEAR;
		int monCyl = Calendar.getInstance().YEAR;
		int dayCyl = Calendar.getInstance().YEAR;
		int leapMonth = 0;
		Date baseDate = null;
		try {
		...
		// 求出和1900年1月31日相差的天数
		int offset = 0;
		if (cal != null && cal.getTime() != null && baseDate != null) {
