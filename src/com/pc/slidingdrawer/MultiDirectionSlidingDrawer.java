 ...
 * governing permissions and limitations under the License. Modifications by:
 * Alessandro Crugnola
 */
...
public class MultiDirectionSlidingDrawer extends ViewGroup {
	...
	private final String LOG_TAG = "MultiDirectionSlidingDrawer";

	private final int TAP_THRESHOLD = 6;
	private final float MAXIMUM_TAP_VELOCITY = 100.0f;
	private final float MAXIMUM_MINOR_VELOCITY = 150.0f;
	private final float MAXIMUM_MAJOR_VELOCITY = 200.0f;
	private final float MAXIMUM_ACCELERATION = 2000.0f;
	private final int VELOCITY_UNITS = 1000;
	private final int MSG_ANIMATE = 1000;
	private final int ANIMATION_FRAME_DURATION = 1000 / 60;

	private final int EXPANDED_FULL_OPEN = -10001;
	private final int COLLAPSED_FULL_CLOSED = -10002;
	...
	public MultiDirectionSlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
		...
		int orientation = a.getInt(R.styleable.MultiDirectionSlidingDrawer_direction, SDOrientation.b2t.ordinal());
		mVertical = (orientation == SDOrientation.b2t.ordinal() || orientation == SDOrientation.t2b.ordinal());
		...
		mInvert = (orientation == SDOrientation.t2b.ordinal() || orientation == SDOrientation.l2r.ordinal());
	 ...
	 * open.
	 * @param onDrawerOpenListener The listener to be notified when the drawer
	 *            is opened.
	 */
	 ...
	 * Sets the listener that receives a notification when the drawer becomes
	 * close.
	 * @param onDrawerCloseListener The listener to be notified when the drawer
	 *            is closed.
	 */
