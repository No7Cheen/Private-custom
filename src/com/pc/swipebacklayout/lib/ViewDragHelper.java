...
public class ViewDragHelper {
	 ...
	 */
	public final int INVALID_POINTER = -1;
	 ...
	 */
	public final int EDGE_ALL = EDGE_LEFT | EDGE_TOP | EDGE_RIGHT | EDGE_BOTTOM;

	/**
	 * Indicates that a check should occur along the horizontal axis
	 */
	public final int DIRECTION_HORIZONTAL = 1 << 0;

	/**
	 * Indicates that a check should occur along the vertical axis
	 */
	public final int DIRECTION_VERTICAL = 1 << 1;

	/**
	 * Indicates that a check should occur along all axes
	 */
	public final int DIRECTION_ALL = DIRECTION_HORIZONTAL | DIRECTION_VERTICAL;

	private final int EDGE_SIZE = 20; // dp

	private final int BASE_SETTLE_DURATION = 256; // ms
