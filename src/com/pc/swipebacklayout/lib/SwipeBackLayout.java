...
public class SwipeBackLayout extends FrameLayout {
	 ...
	 */
	private final int MIN_FLING_VELOCITY = 400; // dips per second

	private final int DEFAULT_SCRIM_COLOR = 0x99000000;
	 ...
	 */
	public final int EDGE_RIGHT = ViewDragHelper.EDGE_RIGHT;

	/**
	 * Edge flag indicating that the bottom edge should be affected.
	 */
	public final int EDGE_BOTTOM = ViewDragHelper.EDGE_BOTTOM;

	/**
	 * Edge flag set indicating all edges should be affected.
	 */
	public final int EDGE_ALL = EDGE_LEFT | EDGE_RIGHT | EDGE_BOTTOM;

	/**
	 * A view is not currently being dragged or animating as a result of a
	 * fling/snap.
	 */
	public final int STATE_IDLE = ViewDragHelper.STATE_IDLE;

	/**
	 * A view is currently being dragged. The position is currently changing as
	 * a result of user input or simulated user input.
	 */
	public final int STATE_DRAGGING = ViewDragHelper.STATE_DRAGGING;

	/**
	 * A view is currently settling into place as a result of a fling or
	 * predefined non-interactive motion.
	 */
	public final int STATE_SETTLING = ViewDragHelper.STATE_SETTLING;

	/**
	 * Default threshold of scroll
	 */
	private final float DEFAULT_SCROLL_THRESHOLD = 0.3f;

	private final int OVERSCROLL_DISTANCE = 10;
	...
	public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		setShadow(R.drawable.sliding_shadow, EDGE_LEFT);
		setShadow(R.drawable.sliding_shadow_right, EDGE_RIGHT);
		// setShadow(R.drawable.sliding_shadow, EDGE_BOTTOM);
	}
